...
from views.Repozytorium_Zasad.repozytoriumZadan import repoScreen
...
SCREENS = {
            ...
            'rules_repository': {'class': repoScreen, 'kv': f'{KV_FILE_PATH}/Repozytorium_Zasad/rules_repository.kv'},
